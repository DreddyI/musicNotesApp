...
class Question extends Component {
    ...
    render() {
        ...
        // console.log(question.correctNote);
    ...
    alert = (answer)=>{
        ...
        if(this.props.settingsStore.isGameFinished){
            ...
            this.props.settingsStore.prepareQuestion();
        }
        // const isCorrect = something ? 'Правильно' : 'Не правильно';
        // Alert.alert('You pressed '+isCorrect);
    }
}
